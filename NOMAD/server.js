  ...
  const cityEventTemplates = {
    hyderabad: {
      cultural: [
        ...
        { title: 'Deccan Heritage Walk', venue: 'Charminar', image: 'https://images.unsplash.com/photo-1533174000222-26a96bc8e612?w=640&h=480&fit=crop' },
      ],
      food: [
    ...
    delhi: {
      cultural: [
        ...
        { title: 'Old Delhi Heritage Walk', venue: 'Chandni Chowk', image: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=640&h=480&fit=crop' },
      ],
      food: [
        { title: 'Chandni Chowk Street Food Festival', venue: 'Paranthe Wali Gali', image: 'https://images.unsplash.com/photo-1589302168068-964664d93dc0?w=640&h=480&fit=crop' },
        { title: 'Delhi Kebab & Biryani Mela', venue: 'Karim\'s, Jama Masjid', image: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=640&h=480&fit=crop' },
      ],
    },
    mumbai: {
      cultural: [
        { title: 'Kala Ghoda Arts Festival', venue: 'Kala Ghoda, Fort', image: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=640&h=480&fit=crop' },
        { title: 'Marine Drive Music Night', venue: 'Marine Drive', image: 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=640&h=480&fit=crop' },
      ],
      food: [
        { title: 'Mumbai Street Food Festival', venue: 'Juhu Beach', image: 'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=640&h=480&fit=crop' },
      ],
    },
    bangalore: {
      cultural: [
        { title: 'Bangalore Open Air Music Fest', venue: 'Cubbon Park', image: 'https://images.unsplash.com/photo-1533174000222-26a96bc8e612?w=640&h=480&fit=crop' },
      ],
      food: [
        { title: 'South Indian Breakfast Festival', venue: 'VV Puram Food Street', image: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=640&h=480&fit=crop' },
      ],
    },
  };

  const templates = cityEventTemplates[city] || {
    cultural: [{ title: `${capCity} Cultural Night`, venue: `Downtown ${capCity}`, image: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=640&h=480&fit=crop' }],
    food: [{ title: `Street Food Festival ${capCity}`, venue: `Central Park, ${capCity}`, image: 'https://images.unsplash.com/photo-1606491956689-2ea866880c84?w=640&h=480&fit=crop' }],
  };
...
app.get('/api/places/:city', async (req, res) => {
  ...
  const cityFallbacks = {
    hyderabad: [
      { id: 1, name: 'Charminar', category: 'Heritage Fort', description: 'Iconic 16th-century mosque and monument, the global symbol of Hyderabad.', image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?w=640&h=480&fit=crop', rating: 4.8, timings: '9:30 AM – 5:30 PM', entry: '₹25' },
      { id: 2, name: 'Golconda Fort', category: 'Heritage Fort', description: 'Magnificent 13th-century fort famous for its acoustics and diamond history.', image: 'https://images.unsplash.com/photo-1587474260584-136574528ed5?w=640&h=480&fit=crop', rating: 4.7, timings: '8:00 AM – 5:30 PM', entry: '₹15' },
      { id: 3, name: 'Hussain Sagar Lake', category: 'Lake', description: 'Heart-shaped lake with a monolithic Buddha statue, connecting Twin Cities.', image: 'https://images.unsplash.com/photo-1564507592227-88481457f544?w=640&h=480&fit=crop', rating: 4.5, timings: 'Open 24/7', entry: 'Free' },
      { id: 4, name: 'Ramoji Film City', category: 'Attraction', description: 'World\'s largest film studio complex with guided tours and entertainment.', image: 'https://images.unsplash.com/photo-1514222134-b57fbb8ce073?w=640&h=480&fit=crop', rating: 4.6, timings: '9:00 AM – 5:30 PM', entry: '₹1250' },
      { id: 5, name: 'Salar Jung Museum', category: 'Museum', description: 'One of India\'s three National Museums with a vast collection of art & artifacts.', image: 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?w=640&h=480&fit=crop', rating: 4.6, timings: '10:00 AM – 5:00 PM', entry: '₹20' },
      { id: 6, name: 'Birla Mandir', category: 'Temple', description: 'Stunning white marble temple atop Naubath Pahad hill with panoramic city views.', image: 'https://images.unsplash.com/photo-1548013146-72479768bada?w=640&h=480&fit=crop', rating: 4.7, timings: '7:00 AM – 12:00 PM, 2:00 PM – 9:00 PM', entry: 'Free' },
      { id: 7, name: 'Chowmahalla Palace', category: 'Heritage Fort', description: 'Seat of the Asaf Jahi dynasty, showcasing Nizami grandeur and vintage cars.', image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?w=640&h=480&fit=crop', rating: 4.5, timings: '10:00 AM – 5:00 PM', entry: '₹80' },
      { id: 8, name: 'Nehru Zoological Park', category: 'Park', description: 'One of India\'s largest zoos with safari rides, spread over 380 acres.', image: 'https://images.unsplash.com/photo-1587474260584-136574528ed5?w=640&h=480&fit=crop', rating: 4.3, timings: '8:30 AM – 5:00 PM', entry: '₹40' }
    ],
    mumbai: [
      { id: 1, name: 'Gateway of India', category: 'Heritage Fort', description: 'Iconic monument on the waterfront overlooking the Arabian Sea.', image: 'https://images.unsplash.com/photo-1564507592227-88481457f544?w=640&h=480&fit=crop', rating: 4.7, timings: 'Open 24/7', entry: 'Free' },
      { id: 2, name: 'Marine Drive', category: 'Attraction', description: 'C-shaped boulevard along the coast, famous as the Queen\'s Necklace.', image: 'https://images.unsplash.com/photo-1514222134-b57fbb8ce073?w=640&h=480&fit=crop', rating: 4.8, timings: 'Open 24/7', entry: 'Free' },
      { id: 3, name: 'Chhatrapati Shivaji Maharaj Vastu Sangrahalaya', category: 'Museum', description: 'Premier art and history museum in India.', image: 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?w=640&h=480&fit=crop', rating: 4.6, timings: '10:15 AM - 6:00 PM', entry: '₹100' }
    ],
    bangalore: [
      { id: 1, name: 'Lalbagh Botanical Garden', category: 'Park', description: 'Historic botanical garden with a famous glass house.', image: 'https://images.unsplash.com/photo-1548013146-72479768bada?w=640&h=480&fit=crop', rating: 4.6, timings: '6:00 AM - 7:00 PM', entry: '₹30' },
      { id: 2, name: 'Bangalore Palace', category: 'Heritage Fort', description: 'Majestic palace built in Tudor Revival style architecture.', image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?w=640&h=480&fit=crop', rating: 4.5, timings: '10:00 AM - 5:30 PM', entry: '₹250' },
      { id: 3, name: 'Cubbon Park', category: 'Park', description: 'Landmark park in the heart of the city.', image: 'https://images.unsplash.com/photo-1587474260584-136574528ed5?w=640&h=480&fit=crop', rating: 4.7, timings: '6:00 AM - 6:00 PM', entry: 'Free' }
    ],
    delhi: [
      { id: 1, name: 'India Gate', category: 'Heritage Fort', description: 'War memorial arch on Rajpath, the heart of ceremonial New Delhi.', image: 'https://images.unsplash.com/photo-1564507592227-88481457f544?w=640&h=480&fit=crop', rating: 4.8, timings: 'Open 24/7', entry: 'Free' },
      { id: 2, name: 'Red Fort', category: 'Heritage Fort', description: 'Mughal-era fortress and UNESCO site where the Prime Minister hoists the flag on Independence Day.', image: 'https://images.unsplash.com/photo-1514222134-b57fbb8ce073?w=640&h=480&fit=crop', rating: 4.7, timings: '9:30 AM – 4:30 PM', entry: '₹35' },
      { id: 3, name: 'Qutub Minar', category: 'Heritage Fort', description: '73-metre victory tower and the tallest brick minaret in the world.', image: 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?w=640&h=480&fit=crop', rating: 4.6, timings: '7:00 AM – 5:00 PM', entry: '₹30' },
      { id: 4, name: 'Lotus Temple', category: 'Temple', description: 'Striking Baháʼí House of Worship shaped like a blooming lotus flower.', image: 'https://images.unsplash.com/photo-1548013146-72479768bada?w=640&h=480&fit=crop', rating: 4.6, timings: '9:00 AM – 5:30 PM', entry: 'Free' },
      { id: 5, name: 'Humayun\'s Tomb', category: 'Heritage Fort', description: 'Garden tomb that inspired the Taj Mahal — a masterpiece of Mughal architecture.', image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?w=640&h=480&fit=crop', rating: 4.7, timings: '6:00 AM – 6:00 PM', entry: '₹30' },
      { id: 6, name: 'Akshardham', category: 'Temple', description: 'Sprawling Hindu temple complex with exhibitions, gardens, and a musical fountain.', image: 'https://images.unsplash.com/photo-1587474260584-136574528ed5?w=640&h=480&fit=crop', rating: 4.8, timings: '10:00 AM – 6:30 PM', entry: 'Free (exhibits extra)' },
      { id: 7, name: 'Chandni Chowk', category: 'Attraction', description: 'Legendary Old Delhi bazaar — spices, jewellery, street food, and Mughal lanes.', image: 'https://images.unsplash.com/photo-1564507592227-88481457f544?w=640&h=480&fit=crop', rating: 4.5, timings: '10:00 AM – 9:00 PM', entry: 'Free' },
      { id: 8, name: 'Connaught Place', category: 'Attraction', description: 'Colonial-era circular market and Delhi\'s commercial and nightlife hub.', image: 'https://images.unsplash.com/photo-1514222134-b57fbb8ce073?w=640&h=480&fit=crop', rating: 4.4, timings: 'Open 24/7', entry: 'Free' }
    ]
  };
...
app.get('/api/foods/:city', async (req, res) => {
  ...
  const curatedFoods = {
    hyderabad: [
      ...
      { id: 'f5', name: 'Qubani Ka Meetha', type: 'Dessert', description: 'Traditional Hyderabadi dessert of stewed apricots topped with fresh cream.', image: 'https://images.unsplash.com/photo-1551024601-bec78aea704b?w=640&h=480&fit=crop', must_try_at: 'Hotel Shadab, Paradise', price_range: 'Low', reviews: [], avg_rating: 4.5 },
    ...
    mumbai: [
      { id: 'f1', name: 'Vada Pav', type: 'Street Food', description: 'The lifeline of Mumbai - deep fried potato dumpling inside a bread bun.', image: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?w=640&h=480&fit=crop', must_try_at: 'Ashok Vada Pav, Aaram Vada Pav', price_range: 'Low', reviews: [], avg_rating: 4.8 },
      { id: 'f2', name: 'Pav Bhaji', type: 'Local Famous', description: 'Spicy mash of vegetables served hot with butter-soaked bread.', image: 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=640&h=480&fit=crop', must_try_at: 'Sardar Pav Bhaji, Cannon Pav Bhaji', price_range: 'Moderate', reviews: [], avg_rating: 4.7 },
      { id: 'f3', name: 'Pani Puri', type: 'Street Food', description: 'Crispy hollow puris filled with tangy tamarind water and spiced potato.', image: 'https://images.unsplash.com/photo-1589302168068-964664d93dc0?w=640&h=480&fit=crop', must_try_at: 'Elco Market, Juhu Beach stalls', price_range: 'Low', reviews: [], avg_rating: 4.8 },
      { id: 'f4', name: 'Bombay Sandwich', type: 'Street Food', description: 'Toasted sandwich layered with chutney, cucumber, tomato, and masala potatoes.', image: 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?w=640&h=480&fit=crop', must_try_at: 'Churchgate stalls, Dadar market', price_range: 'Low', reviews: [], avg_rating: 4.6 }
    ],
    bangalore: [
      { id: 'f1', name: 'Masala Dosa', type: 'Local Delicacy', description: 'Crispy rice crepe stuffed with spiced potato filling, served with chutneys.', image: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=640&h=480&fit=crop', must_try_at: 'CTR, Vidyarthi Bhavan, MTR', price_range: 'Moderate', reviews: [], avg_rating: 4.8 },
      { id: 'f2', name: 'Filter Coffee', type: 'Beverage', description: 'Strong, frothy traditional South Indian coffee brewed in a metal tumbler.', image: 'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=640&h=480&fit=crop', must_try_at: 'MTR, Brahmin\'s Coffee Bar, Koshy\'s', price_range: 'Low', reviews: [], avg_rating: 4.9 },
      { id: 'f3', name: 'Akki Roti', type: 'Local Delicacy', description: 'Rice flour flatbread with vegetables and spices — a Karnataka staple.', image: 'https://images.unsplash.com/photo-1606491956689-2ea866880c84?w=640&h=480&fit=crop', must_try_at: 'Brahmin\'s Coffee Bar, Vidyarthi Bhavan', price_range: 'Low', reviews: [], avg_rating: 4.6 },
      { id: 'f4', name: 'Bisi Bele Bath', type: 'Local Famous', description: 'Hot lentil rice dish cooked with tamarind, vegetables, and aromatic spices.', image: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?w=640&h=480&fit=crop', must_try_at: 'MTR, Mavalli Tiffin Rooms', price_range: 'Low', reviews: [], avg_rating: 4.7 }
    ],
    delhi: [
      { id: 'f1', name: 'Butter Chicken', type: 'Local Famous', description: 'Iconic creamy tomato-based chicken curry born in Delhi\'s kitchens.', image: 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=640&h=480&fit=crop', must_try_at: 'Moti Mahal, Kake Da Hotel', price_range: 'Moderate', reviews: [], avg_rating: 4.9 },
      { id: 'f2', name: 'Chole Bhature', type: 'Street Food', description: 'Fluffy fried bread with spicy chickpea curry — the ultimate Delhi breakfast.', image: 'https://images.unsplash.com/photo-1589302168068-964664d93dc0?w=640&h=480&fit=crop', must_try_at: 'Sitaram Diwan Chand, Kwality', price_range: 'Low', reviews: [], avg_rating: 4.8 },
      { id: 'f3', name: 'Paranthe Wali Gali', type: 'Street Food', description: 'Famous Chandni Chowk stuffed parathas with unusual fillings like rabri and dry fruits.', image: 'https://images.unsplash.com/photo-1548013146-72479768bada?w=640&h=480&fit=crop', must_try_at: 'Paranthe Wali Gali, Chandni Chowk', price_range: 'Low', reviews: [], avg_rating: 4.7 },
      { id: 'f4', name: 'Kebabs', type: 'Local Famous', description: 'Smoky seekh and galouti kebabs from Old Delhi\'s legendary grill houses.', image: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=640&h=480&fit=crop', must_try_at: 'Karim\'s, Al Jawahar, Qureshi Kabab', price_range: 'Moderate', reviews: [], avg_rating: 4.8 },
      { id: 'f5', name: 'Chole Kulche', type: 'Street Food', description: 'Soft kulcha bread with tangy chole — a Delhi street-food classic.', image: 'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=640&h=480&fit=crop', must_try_at: 'Chache Di Hatti, Nagpal Chole Bhature', price_range: 'Low', reviews: [], avg_rating: 4.6 },
      { id: 'f6', name: 'Dahi Bhalla', type: 'Street Food', description: 'Lentil dumplings in creamy yogurt with chutneys and chaat masala.', image: 'https://images.unsplash.com/photo-1606491956689-2ea866880c84?w=640&h=480&fit=crop', must_try_at: 'Natraj Dahi Bhalle Wala, Bikanervala', price_range: 'Low', reviews: [], avg_rating: 4.5 }
    ],
    chennai: [
      { id: 'f1', name: 'Idli Sambhar', type: 'Local Delicacy', description: 'Soft steamed rice cakes served with lentil vegetable stew and chutneys.', image: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?w=640&h=480&fit=crop', must_try_at: 'Saravana Bhavan, Murugan Idli Shop', price_range: 'Low', reviews: [], avg_rating: 4.8 },
      { id: 'f2', name: 'Chettinad Chicken Curry', type: 'Local Famous', description: 'Fiery aromatic curry with distinctive Chettinad spices and kalpasi.', image: 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=640&h=480&fit=crop', must_try_at: 'Anjappar, Ponnusamy Hotel', price_range: 'Moderate', reviews: [], avg_rating: 4.9 },
      { id: 'f3', name: 'Kothu Parotta', type: 'Street Food', description: 'Flaky bread shredded and stir-fried with egg, onions, and spices.', image: 'https://images.unsplash.com/photo-1589302168068-964664d93dc0?w=640&h=480&fit=crop', must_try_at: 'Burma Bazaar, street stalls', price_range: 'Low', reviews: [], avg_rating: 4.7 }
    ],
    kolkata: [
      { id: 'f1', name: 'Kathi Roll', type: 'Street Food', description: 'Paratha wrapped around spiced egg and meat filling — invented in Kolkata.', image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?w=640&h=480&fit=crop', must_try_at: 'Nizam\'s, Hot Kathi Rolls', price_range: 'Low', reviews: [], avg_rating: 4.8 },
      { id: 'f2', name: 'Rosogolla', type: 'Dessert', description: 'Spongy cottage cheese balls soaked in light sugar syrup — a Bengal original.', image: 'https://images.unsplash.com/photo-1587474260584-136574528ed5?w=640&h=480&fit=crop', must_try_at: 'K.C. Das, Balaram Mullick', price_range: 'Low', reviews: [], avg_rating: 4.9 },
      { id: 'f3', name: 'Hilsa Fish Curry', type: 'Local Famous', description: 'Hilsa fish cooked in mustard paste — the pride of Bengali cuisine.', image: 'https://images.unsplash.com/photo-1564507592227-88481457f544?w=640&h=480&fit=crop', must_try_at: '6 Ballygunge Place, Bhojohori Manna', price_range: 'Moderate', reviews: [], avg_rating: 4.8 }
    ]
  };
